...
{%- set test1 = dbt_flow.setup_test(target_model='orders4', test_name='orders4', options={"drop_tables": false}, test_description="test array columns support in bigquery.",
  mocks={
    "stg__orders": """
