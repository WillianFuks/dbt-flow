...
{%- set test1 = dbt_flow.setup_test(target_model='orders2', test_name='orders3', options={"drop_tables": false, "test_incremental": true}, test_description="Test again merge behavior but with unique_key defined.",
  mocks={
    "stg__orders": """
